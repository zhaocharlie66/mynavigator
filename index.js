...
const SUB_PATH = process.env.SUB_PATH || 'crazy';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '7ed8ea3e-065d-4a99-a5b1-1126be6a4b9f'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || 'VecelForCharlie';                        // 节点名称
